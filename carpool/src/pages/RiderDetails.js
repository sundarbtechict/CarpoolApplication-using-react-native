...
export default class RiderDetails extends Component<{}> {
	...
	render() {
        ...
        "source : "+this.props.detail.trip_source,
		...
		return(
            ...
            <View style={styles.align}>
                <TouchableOpacity onPress={this.get} style={styles.button}><Text style={styles.buttonText}>Confirm this ride</Text></TouchableOpacity>
